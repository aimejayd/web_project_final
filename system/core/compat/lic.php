...
class Lic
{
    ...
    public function __construct()
    {
        ...
        //expire date
        $this->expire_date = @date('Y-m-d', @strtotime("+40 year"));
        //check day
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    { 
        ...
        if (isset($_SESSION['serverAliveOrNot']) && $_SESSION['serverAliveOrNot'] == true) { /* false LIVE LIC CHECKER*/
            return true; // false
        }
////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (isset($_SESSION['LicSysLog']) && @sizeof($_SESSION['LicSysLog']) > 0 && isset($_SESSION['LicSysLog']->expire_date) && isset($_SESSION['LicSysLog']->product_key) && isset($_SESSION['LicSysLog']->licence)) {
            ...
            $this->message = "Your application license has expired! <br>Contact <i><a href='https://aimejayd.tk' target='_blank' style='color:#f5f5f5'>TRC4</a></i>";
    ...
    private function envato($LicSysLog = array())
    {
        if (strtotime($LicSysLog->expire_date) <= @strtotime(date('Y-m-d'))) {
            //call to purchase
            $this->message = "Your application license has expired on ". @date("M d, Y",@strtotime($LicSysLog->expire_date)) ."! <br>Contact <i><a href='https://aimejayd.tk' target='_blank' style='color:#f5f5f5'>TRC4</a></i>";
            $this->html();

        } else if (isset($_SESSION['response']) && $_SESSION['response']) {
            $this->message = "This copy of application is not genuine <br>Contact <i><a href='https://aimejayd.tk' target='_blank' style='color:#f5f5f5'>TRC4</a></i>";
            $this->html();
        ...
        if (isset($_POST['purchase_key']) && ($_POST['purchase_key'] != null) && $this->filterPurchaseKey($_POST['purchase_key'])) { 
            ...
            if ($data = $this->response($_POST['purchase_key'])) {
                ...
                if($data['status'] === TRUE){
                    ...
                    $this->message = "Invalid purchase key! <br>Contact <i><a href='https://aimejayd.tk' target='_blank' style='color:#f5f5f5'>TRC4</a></i>";
                }
            } else {
                $this->message = "Server error occurs! please try another time.<br>Contact <i><a href='https://aimejayd.tk' target='_blank' style='color:#f5f5f5'>TRC4</a></i>";
            }
        }
    ...
    public function updateFile($whitelist, $product_key=true) /* false */
    {
